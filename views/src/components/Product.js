      ...
      <div className={`product ${this.props.mode}`}>
        ...
        <div className="product-image">
          ...
          <div className="product-actions">
            <Action text={this.props.actionText} job={this.props.actionJob} callback={this.props.actionCallback} url="http://127.0.0.1:7070/users/5b646febeebb915ff8b221be" id={product._id} />
          </div>
        </div>
      </div>
    );
